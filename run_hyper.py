...
def main():
    ...
    parser.add_argument('--config_files', type=str, default='seq.yaml', help='fixed config files')
    parser.add_argument('--params_file', type=str, default='hu.test', help='parameters file')
